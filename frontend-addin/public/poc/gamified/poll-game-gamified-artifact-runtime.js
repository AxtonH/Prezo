...
function buildBridgeScript(instanceId = 0) {
  ...
  return [
    ...
    '    if (!body) {',
    '      return { textLength: 0, elementCount: 0, visibleElementCount: 0, largeVisibleElementCount: 0, mediaCount: 0, largeDarkCoverCount: 0, likelyBlank: false }',
    '    }',
    ...
    '      : 0',
    '    if (bodyAreaRatio >= 0.72 && isDarkOpaqueColor(bodyStyle && bodyStyle.backgroundColor)) {',
    ...
    '      }',
    '      if (areaRatio >= 0.72 && isDarkOpaqueColor(style && style.backgroundColor)) {',
    '        largeDarkCoverCount += 1',
    '      }',
    '    }',
    '    return {',
