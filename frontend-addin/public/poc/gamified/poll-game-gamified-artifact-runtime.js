...
function buildBridgeScript() {
  return [
    ...
    '        continue',
    '      }',
    '      var ownText = hasDirectRenderableText(node)',
    '      var childCount = node.children ? node.children.length : 0',
    '      if (!ownText && childCount > 0) {',
    '        continue',
    '      }',
    ...
    '      var shiftY = computeDecorationSafeShift(rect, textEntries)',
    '      setDecorationShift(node, shiftY)',
    '      var effectiveRect = shiftRect(rect, shiftY)',
    ...
    '          continue',
    '        }',
    '        if (!rectsOverlap(effectiveRect, textEntry.rect)) {',
    '          continue',
    '        }',
