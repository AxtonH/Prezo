...
function buildBridgeScript() {
  return [
    ...
    '      return',
    '    }',
    '    var textRects = collectTextRects()',
    '    if (!textRects.length) {',
    '      return',
    '    }',
    ...
    '        if (node.dataset && node.dataset.prezoDecorationHidden === "1") {',
    ...
    '      }',
    '      var overlaps = false',
    '      for (var textIndex = 0; textIndex < textRects.length; textIndex += 1) {',
    '        if (rectsOverlap(rect, textRects[textIndex])) {',
    '          overlaps = true',
    '          break',
    '        }',
    '      }',
    ...
    '        if (node.dataset) {',
    '          node.dataset.prezoDecorationHidden = "1"',
    '        }',
    '        continue',
    '      }',
    '      if (node.dataset && node.dataset.prezoDecorationHidden === "1") {',
