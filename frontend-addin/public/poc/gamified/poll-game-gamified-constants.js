...
export const RIBBON_ADVANCED_KEY = 'prezo.poll-game-poc.ribbon-advanced.v1'
...
export const AI_GEMINI_MODEL_STORAGE_KEY = 'prezo.poll-game-poc.gemini-model.v1'
export const AI_GEMINI_DEFAULT_MODEL = 'gemini-3-flash-preview'
export const AI_GEMINI_LEGACY_MODELS = new Set(['gemini-2.0-flash', 'models/gemini-2.0-flash'])
